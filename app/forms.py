...
class LoginForm(AuthenticationForm):
    ...
    password=forms.CharField(label=_("Password"), strip=False, widget=forms.PasswordInput(attrs={'auto_complete':'current-password','class':'form-control'}))
...
class MyPasswordResetForm(PasswordResetForm):
    email= forms.EmailField(label=_("Email"), max_length=250, widget=forms.EmailInput
